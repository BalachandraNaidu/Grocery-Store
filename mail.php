...
if(!isset($_SESSION["user"])){
	header("Location: /grocery_store/login.php");
}?>
<!DOCTYPE html>
<html>
<head>
			...
			<div class="agileinfo_mail_grids">
				<div class="col-md-4 agileinfo_mail_grid_left">
					<ul>
						...
						<li>address<span>rgukt,r.k valley,vempalli,kadapa</span></li>
					</ul>
					<ul>
						<li><i class="fa fa-envelope" aria-hidden="true"></i></li>
						<li>email<span><a href="mailto:ybalunaidu@gmail.com">ybalunaidu@gmail.com</a></span></li>
					</ul>
					<ul>
						<li><i class="fa fa-phone" aria-hidden="true"></i></li>
						<li>call to us<span>(+91) 9963089038</span></li>
					</ul>
				</div>
